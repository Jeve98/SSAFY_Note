...
Data Type's LSB && MSB
- LSB(Least Significant Bit) : 하나의 데이터 형에서 가장 낮은 위치의 bit
    >> 주로 난수 발생 함수, 해시 함수, checksum 함수 등에서 사용
- MSB(Most Significant Bit) : 하나의 데이터 형에서 가장 높은 위치의 bit
    >> signed 데이터 타입에서는 부호를 의미
